...
module Combine = struct
    ...
    let alpha = Int32.of_int 65599
    let beta  = Int32.of_int 7
    let cap x = Int32.logand x (Int32.of_int 0x3FFFFFFF)
    let combine x y     = Int32.add (Int32.mul x alpha) y |> cap
    let combinei x y = combine (Int32.of_int x) y
    let combineii x y = combine (Int32.of_int x) (Int32.of_int y)
    let combine_i x y = combine x (Int32.of_int y)
    ...
    let combinesmalli x y = combinesmall (Int32.of_int x) y
    let combinesmallii x y = combinesmall (Int32.of_int x) (Int32.of_int y)
end
