...
struct
  ...
  | ConstRef c -> combinesmalli 1 (Constant.SyntacticOrd.hash c)
  | IndRef i -> combinesmalli 2 (ind_syntactic_hash i)
  | ConstructRef c -> combinesmalli 3 (constructor_syntactic_hash c)
end
