...
let option_hash hf z = Option.map hf z |> Option.default Int32.zero
...
let primitive_hash = function
  ...
  | Mk_meta -> Int32.of_int 19
  | Mk_evar -> Int32.of_int 20
  | MLand -> Int32.of_int 21
  | MLle -> Int32.of_int 22
  | MLlt -> Int32.of_int 23
  | MLinteq -> Int32.of_int 24
  | MLlsl -> Int32.of_int 25
  | MLlsr -> Int32.of_int 26
  | MLland -> Int32.of_int 27
  | MLlor -> Int32.of_int 28
  | MLlxor -> Int32.of_int 29
  | MLadd -> Int32.of_int 30
  | MLsub -> Int32.of_int 31
  | MLmul -> Int32.of_int 32
  | MLmagic -> Int32.of_int 33
  | Coq_primitive (prim, None) -> combinesmalli 34 (CPrimitives.hash prim)
  | Coq_primitive (prim, Some (prefix,(kn,_))) ->
     combinesmalli 35 (combine3 (Int32.of_int @@ String.hash prefix) (Constant.hash kn) (CPrimitives.hash prim))
  | Mk_proj -> Int32.of_int 36
  | MLarrayget -> Int32.of_int 37
  | Mk_empty_instance -> Int32.of_int 38
